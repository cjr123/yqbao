...
class UtilHelper
{
     ...
     * @return string
     */
    public static function getSignature($httpMethod,$accept,$contentType,$contentMd5,$date,$headers,$url,$key){
        ...
        $signature = hash_hmac("sha256",utf8_encode($stringToSign), utf8_encode($key), true);
